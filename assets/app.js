...
function renderInteractiveShop() {
  ...
  const shopProducts = [
    ...
    { category: "instagram", label: "Instagram & Canva", title: "Carrousels aesthetic scrapbook & stickers", description: "Des carrousels et stories façon scrapbook rose, accompagnés d’éléments et stickers coordonnés.", badge: "Aesthetic pack", image: "assets/shop/plr/carousel-scrapbook.png" },
    ...
    { category: "marketing", label: "Marketing digital", title: "Ebook Comment vendre en Story", description: "Une méthode pour structurer des stories Instagram qui créent du lien et conduisent naturellement vers une vente.", badge: "Guide pratique", image: "assets/shop/plr/vendre-story.jpg" },
    { category: "business", label: "Templates Etsy", title: "Etsy Listing Mockup Templates", description: "Des modèles Canva pour créer rapidement des visuels d’annonces Etsy cohérents et professionnels.", badge: "Kit Etsy", image: "assets/shop/plr/mockups-etsy.jpg" },
    ...
    { category: "marketing", label: "Etsy & produits digitaux", title: "Guide Etsy Produits Digitaux", description: "Un système complet pour ouvrir, organiser et développer une boutique Etsy de produits digitaux.", badge: "Système Etsy", image: "assets/shop/plr/guide-etsy.png" },
    { category: "marketing", label: "Marketing digital", title: "Guide du Marketing d’Affiliation", description: "Une ressource pour comprendre l’affiliation, choisir ses offres et construire une stratégie de revenus.", badge: "Débutantes", image: "assets/shop/plr/guide-affiliation.jpg" },
    ...
    { category: "business", label: "Templates Etsy", title: "Modèles d’instructions & téléchargement Etsy", description: "Des modèles pour guider les clientes après leur achat et professionnaliser l’expérience de téléchargement.", badge: "80 templates", image: "assets/shop/plr/instructions-etsy.jpg" },
    ...
    { category: "business", label: "Pages de vente", title: "Pages de vente Beacons & Stan Store", description: "Des pages de vente Canva pour présenter une offre digitale sur Beacons, Stan Store ou une page de lien en bio.", badge: "Sales page kit", image: "assets/shop/plr/sales-page.png" },
    { category: "seasonal", label: "Collections saisonnières", title: "Planificateur de Noël", description: "Un planner saisonnier pour organiser préparatifs, repas, budget, activités et célébrations de Noël.", badge: "Planner de Noël", image: "assets/shop/plr/planificateur-noel.png" },
    { category: "seasonal", label: "Collections saisonnières", title: "Suivi des cadeaux de Noël", description: "Une ressource pratique pour organiser les idées, achats, budgets et cadeaux à offrir pendant les fêtes.", badge: "Organisation Noël", image: "assets/logo-bibliotheque-digitale.jpg" },
    ...
    { category: "business", label: "Templates de site", title: "VA Canva Website Template", description: "Un site Canva destiné aux assistantes virtuelles, OBM, freelances et social media managers.", badge: "Website template", image: "assets/shop/plr/va-website.jpg" },
    { category: "planners", label: "Mindset & objectifs", title: "Vision Board", description: "Une ressource créative pour visualiser ses objectifs et composer un tableau de vision personnel ou professionnel.", badge: "Vision & objectifs", image: "assets/shop/plr/vision-board.png" }
  ];
